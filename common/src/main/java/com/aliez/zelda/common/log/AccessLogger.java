...
/**
 * @author: z.j.
 * @time: 2020-11-25 16:50
 */
public class AccessLogger extends AbstractLogger{


    public AccessLogger(LoggerResources res) throws LoggerException {
        this.createAccessLogger(res);
    }


    private void createAccessLogger(LoggerResources res) throws LoggerException{
